...
export default class parentEducationSearch extends LightningElement {
    ...
    fetchAllEmployeeData() {
        ...
        getAllEmployeeInProgress()
            .then((result) => {
                console.log('before Inprodata: '+JSON.stringify(result));
                ...
                console.log('Inprodata: '+JSON.stringify(this.data));
    ...
    filterData() {
        ...
        // 필터링 적용
        let dummydata = JSON.parse(JSON.stringify(this.data));
        let dummydata2 = JSON.parse(JSON.stringify(this.data2));
       
        this.displayData = dummydata.filter(filterItem);
        this.displayData2 = dummydata2.filter(filterItem);
    }
